...
config.setScreenResolution("1280x800"); // set config parameters
// etc
...
p. and then you can send tracking data with the @trackPageView@ and @trackEvent@ methods, or make your own request with @makeCustomRequest(AnalyticsRequestData)@
